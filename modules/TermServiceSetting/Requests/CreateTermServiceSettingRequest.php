...
class CreateTermServiceSettingRequest extends FormRequest
{
    ...
    public function createCreateTermServiceSettingDTO(): CreateTermServiceSettingDTO
    {
        return new CreateTermServiceSettingDTO(
            name: $this->get('name'),
