...
Route::group(['middleware' => ['auth:api', \Stancl\Tenancy\Middleware\InitializeTenancyByRequestData::class]], function () {
    Route::get('/', [JobTitleController::class, 'index'])->permission(Permission::ORGANIZATION_JOB_TITLE_VIEW());
    Route::get('/list', [JobTitleController::class, 'listSimple'])->permission(Permission::ORGANIZATION_JOB_TITLE_VIEW());
