...
class ProcedureSettingPresenter extends AbstractPresenter
{
    ...
    protected function present(bool $isListing = false): array
    {
        ...
        if (! $isListing && $this->procedureSetting->relationLoaded('internalProcedures')) {
            $data['internal_procedures'] = InternalProcedureSettingPresenter::collection(
                $this->procedureSetting->internalProcedures
            );
        }
