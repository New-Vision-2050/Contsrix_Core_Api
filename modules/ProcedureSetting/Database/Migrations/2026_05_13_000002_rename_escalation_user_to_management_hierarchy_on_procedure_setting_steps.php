...
{
    private const OLD_FK = 'ps_steps_esc_user_fk';

    private const NEW_FK = 'ps_steps_esc_user_mh_fk';
    ...
    public function up(): void
    {
        ...
        // Add new column
        Schema::table('procedure_setting_steps', function (Blueprint $table) {
            $table->unsignedBigInteger('escalation_management_hierarchy_id')->nullable()->after('notify_by_whatsapp');
        });
    ...
    public function down(): void
    {
        ...
        // Drop new column
        if (Schema::hasColumn('procedure_setting_steps', 'escalation_management_hierarchy_id')) {
            Schema::table('procedure_setting_steps', function (Blueprint $table) {
        ...
        // Restore old column
        Schema::table('procedure_setting_steps', function (Blueprint $table) {
            $table->uuid('escalation_user_id')->nullable()->after('notify_by_whatsapp');
        });
