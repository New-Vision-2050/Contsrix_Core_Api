...
{
    /**
     * The ConfirmProjectNotificationPresence form was removed from the
     * ProjectNotificationProcedureSeeder and workflow. This migration deletes
     * any leftover procedure_settings rows that still use that form, along
     * with their associated workflow records.
     *
