...
class EmployeeTaskWorkflowSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($companies as $companyId) {
            foreach (self::TYPES as $type) {
                $this->seedProcedureSettingForCompany((string) $companyId, $type);
            }
        }

        $this->command?->info('EmployeeTaskWorkflowSeeder finished.');
    }
