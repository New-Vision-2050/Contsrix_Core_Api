...
class CreateWebsiteServiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'reference_number' => 'nullable|string|unique:website_services,reference_number',
    ...
    public function toDTO(): CreateWebsiteServiceDTO
    {
        return new CreateWebsiteServiceDTO(
            name: [
                'ar' => $this->get('name_ar'),
                'en' => $this->get('name_en'),
            ],
