...
class CreateWebsiteAboutUsRequest extends FormRequest
{
    ...
    public function createCreateWebsiteAboutUsDTO(): CreateWebsiteAboutUsDTO
    {
        return new CreateWebsiteAboutUsDTO(
            title: [
