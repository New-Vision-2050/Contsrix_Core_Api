...
class UpdateWebsiteNewsRequest extends FormRequest
{
    ...
    public function createUpdateWebsiteNewsCommand(): UpdateWebsiteNewsCommand
    {
        return new UpdateWebsiteNewsCommand(
