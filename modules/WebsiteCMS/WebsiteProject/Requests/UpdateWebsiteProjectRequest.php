...
class UpdateWebsiteProjectRequest extends FormRequest
{
    ...
    public function createUpdateWebsiteProjectCommand(): UpdateWebsiteProjectCommand
    {
        return new UpdateWebsiteProjectCommand(
