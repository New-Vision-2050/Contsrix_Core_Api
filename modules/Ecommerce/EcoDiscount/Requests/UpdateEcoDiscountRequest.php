...
class UpdateEcoDiscountRequest extends FormRequest
{
    public function rules(): array
    {
        ...
        return [
            ...
            'code' => [
                ...
                'string',
                'max:50',
                Rule::unique('eco_discounts', 'code')->ignore($discountId)
            ],
    ...
    public function createUpdateEcoDiscountCommand(): UpdateEcoDiscountCommand
    {
        return new UpdateEcoDiscountCommand(
