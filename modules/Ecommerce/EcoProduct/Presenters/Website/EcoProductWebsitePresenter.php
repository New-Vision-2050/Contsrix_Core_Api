...
class EcoProductWebsitePresenter extends AbstractPresenter
{
    ...
    protected function present(bool $isListing = false): array
    {
        ...
        $hasDiscount = (int) ($this->ecoProduct->has_active_discount ?? 0);
        ...
        return [
            ...
            'is_favorite' => (int) $this->ecoProduct->is_favorite??0,
