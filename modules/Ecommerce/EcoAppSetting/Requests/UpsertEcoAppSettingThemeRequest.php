...
class UpsertEcoAppSettingThemeRequest extends FormRequest
{
    ...
    public function createUpsertEcoAppSettingThemeDTO(): UpsertEcoAppSettingThemeDTO
    {
        return  new UpsertEcoAppSettingThemeDTO(
