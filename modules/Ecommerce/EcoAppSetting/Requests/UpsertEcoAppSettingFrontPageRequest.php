...
class UpsertEcoAppSettingFrontPageRequest extends FormRequest
{
    ...
    public function createUpsertEcoAppSettingFrontPageDTO(): UpsertEcoAppSettingFrontPageDTO
    {
        return new UpsertEcoAppSettingFrontPageDTO(
