...
class UpsertEcoBannerSettingRequest extends FormRequest
{
    ...
    public function createUpsertEcoBannerSettingDTO(): UpsertEcoBannerSettingDTO
    {
        return new UpsertEcoBannerSettingDTO(
