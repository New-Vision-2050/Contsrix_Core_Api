...
class UpsertEcoTermsSettingRequest extends FormRequest
{
    ...
    public function createUpsertEcoTermsSettingDTO(): UpsertEcoTermsSettingDTO
    {
        return new UpsertEcoTermsSettingDTO(
