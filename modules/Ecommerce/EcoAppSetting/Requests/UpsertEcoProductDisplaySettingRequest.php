...
class UpsertEcoProductDisplaySettingRequest extends FormRequest
{
    ...
    public function createUpsertEcoProductDisplaySettingDTO(): UpsertEcoProductDisplaySettingDTO
    {
        return new UpsertEcoProductDisplaySettingDTO(
