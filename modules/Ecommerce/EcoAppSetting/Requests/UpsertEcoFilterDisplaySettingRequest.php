...
class UpsertEcoFilterDisplaySettingRequest extends FormRequest
{
    ...
    public function createUpsertEcoFilterDisplaySettingDTO(): UpsertEcoFilterDisplaySettingDTO
    {
        return new UpsertEcoFilterDisplaySettingDTO(
