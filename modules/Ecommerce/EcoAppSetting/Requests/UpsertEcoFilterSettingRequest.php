...
class UpsertEcoFilterSettingRequest extends FormRequest
{
    ...
    public function createUpsertEcoFilterSettingDTO(): UpsertEcoFilterSettingDTO
    {
        return new UpsertEcoFilterSettingDTO(
