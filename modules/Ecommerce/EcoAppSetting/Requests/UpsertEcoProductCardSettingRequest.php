...
class UpsertEcoProductCardSettingRequest extends FormRequest
{
    ...
    public function createUpsertEcoProductCardSettingDTO(): UpsertEcoProductCardSettingDTO
    {
        return new UpsertEcoProductCardSettingDTO(
