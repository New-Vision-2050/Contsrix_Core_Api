...
class UpsertEcoCartSettingRequest extends FormRequest
{
    ...
    public function createUpsertEcoCartSettingDTO(): UpsertEcoCartSettingDTO
    {
        return new UpsertEcoCartSettingDTO(
