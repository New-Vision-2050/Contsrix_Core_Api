...
class UpsertEcoFavoritesSettingRequest extends FormRequest
{
    ...
    public function createUpsertEcoFavoritesSettingDTO(): UpsertEcoFavoritesSettingDTO
    {
        return new UpsertEcoFavoritesSettingDTO(
