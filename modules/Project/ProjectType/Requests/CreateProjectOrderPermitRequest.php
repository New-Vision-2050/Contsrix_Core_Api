...
class CreateProjectOrderPermitRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'work_orders.*.project_completion_phase_id' => ['nullable', 'integer', 'exists:project_completion_phases,id'],
            'work_orders.*.project_phase_status_id' => ['nullable', 'integer', 'exists:project_phase_statuses,id'],
            'work_orders.*.connection_completion_phase_id' => ['nullable', 'integer', 'exists:connection_completion_phases,id'],
            'work_orders.*.connection_phase_status_id' => ['nullable', 'integer', 'exists:connection_phase_statuses,id'],
            'work_orders.*.start_permit_date' => ['nullable', 'date'],
            'work_orders.*.end_permit_date' => ['nullable', 'date'],
            'work_orders.*.note_from_permit_to_departments' => ['nullable', 'string'],
            'work_orders.*.note_from_departments_to_permit' => ['nullable', 'string'],
            'work_orders.*.is_taked_action' => ['nullable', 'boolean'],
            ...
            'work_orders.*.employee_id' => ['nullable', 'string', 'exists:users,id'],
