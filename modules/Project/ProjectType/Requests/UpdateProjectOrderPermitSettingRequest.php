...
class UpdateProjectOrderPermitSettingRequest extends FormRequest
{
    public function authorize(): bool { return true; }

    public function rules(): array { return ['is_shown' => ['sometimes', 'boolean']]; }

    public function toCommand(int $projectTypeId): UpdateProjectOrderPermitSettingCommand
    {
        return new UpdateProjectOrderPermitSettingCommand($projectTypeId, new UpdateProjectOrderPermitSettingDTO(
