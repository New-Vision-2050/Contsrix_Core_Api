...
class CreateSecondLevelProjectTypeRequest extends FormRequest
{
    ...
    public function createDTO(): CreateSecondLevelProjectTypeDTO
    {
        return new CreateSecondLevelProjectTypeDTO(
            name: $this->get('name'),
            icon: $this->get('icon'),
