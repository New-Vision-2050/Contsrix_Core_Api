...
class DepartmentContractSettingPresenter extends AbstractPresenter
{
    private DepartmentContractSetting $setting;

    public function __construct(DepartmentContractSetting $setting)
    {
