...
class EmployeeContractSettingPresenter extends AbstractPresenter
{
    private EmployeeContractSetting $setting;

    public function __construct(EmployeeContractSetting $setting)
    {
