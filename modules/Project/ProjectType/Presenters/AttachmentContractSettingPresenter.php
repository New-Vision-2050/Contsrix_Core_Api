...
class AttachmentContractSettingPresenter extends AbstractPresenter
{
    private AttachmentContractSetting $setting;

    public function __construct(AttachmentContractSetting $setting)
    {
