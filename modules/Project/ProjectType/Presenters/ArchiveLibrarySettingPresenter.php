...
class ArchiveLibrarySettingPresenter extends AbstractPresenter
{
    private ArchiveLibrarySetting $setting;

    public function __construct(ArchiveLibrarySetting $setting)
    {
