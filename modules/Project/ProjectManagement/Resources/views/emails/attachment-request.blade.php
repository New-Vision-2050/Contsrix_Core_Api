          ...
          <tr>
            <td style="padding:32px;">
              ...
              <p style="margin:0 0 24px; font-size:15px; line-height:2; color:#475569;">
                يوجد طلب مرفقات جديد بعنوان <strong>{{ $requestName }}</strong>. برجاء مراجعته التفاصيل واتخاذ الإجراء المناسب.
              </p>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0">
                      <tr>
                        <td style="padding:8px 0; border-bottom:1px solid #e2e8f0;">
                          ...
                          <strong style="display:block; color:#0f172a; font-size:15px; margin-top:4px;">{{ $serialNumber }}</strong>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:8px 0; border-bottom:1px solid #e2e8f0;">
                      ...
                      <tr>
                        <td style="padding:8px 0; border-bottom:1px solid #e2e8f0;">
                          <span style="color:#64748b; font-size:13px;">التاريخ:</span>
                          <strong style="display:block; color:#0f172a; font-size:15px; margin-top:4px;">{{ $date }}</strong>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:8px 0; border-bottom:1px solid #e2e8f0;">
                          <span style="color:#64748b; font-size:13px;">عدد المرفقات:</span>
                          <strong style="display:block; color:#0f172a; font-size:15px; margin-top:4px;">{{ $totalItems }}</strong>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:8px 0; border-bottom:1px solid #e2e8f0;">
                          <span style="color:#64748b; font-size:13px;">المرسل:</span>
                          <strong style="display:block; color:#0f172a; font-size:15px; margin-top:4px;">{{ $senderName }}</strong>
                        </td>
                      </tr>
                      @if($notes)
                      <tr>
                        <td style="padding:8px 0;">
                          <span style="color:#64748b; font-size:13px;">ملاحظات:</span>
                          <p style="color:#0f172a; font-size:14px; margin:4px 0 0; line-height:1.6;">{{ $notes }}</p>
                        </td>
                      </tr>
                      @endif
                    </table>
