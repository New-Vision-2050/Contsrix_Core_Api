...
class ProjectNotificationPresenter
{
    ...
    public function toArray(): array
    {
        ...
        return [
            ...
            'contractor_representative_id' => $n->contractor_representative_id,
            'contractor_technician_id'     => $n->contractor_technician_id,
            'contractor_technician_number' => $n->contractor_technician_number,
            'contractor_representative'   => $n->contractorRepresentative ? [
                'id'       => $n->contractorRepresentative->id,
                'name'     => $n->contractorRepresentative->name,
                'mobile'   => $n->contractorRepresentative->mobile,
                'nationality' => $n->contractorRepresentative->nationality,
            ] : null,
            ...
            'update_site_status_id'       => $n->update_site_status_id,
