...
class CreateProjectManagementRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'responsible_employee_id' => 'nullable|uuid|exists:users,id',
            ...
            'management_id' => 'nullable|uuid|exists:management_hierarchies,id',
    ...
    public function createCreateProjectManagementDTO(): CreateProjectManagementDTO
    {
        return new CreateProjectManagementDTO(
            ...
            name: $this->get('name'),
            responsibleEmployeeId: $this->get('responsible_employee_id'),
