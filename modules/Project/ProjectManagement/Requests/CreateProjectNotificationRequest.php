...
class CreateProjectNotificationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'type'                        => ['nullable', 'string', Rule::in(['electricity', 'water'])],
            ...
            'contractor_technician_id'     => ['nullable', 'uuid', 'exists:project_contractor_representatives,id'],
            'contractor_technician_number' => ['nullable', 'string', 'max:255'],
            ...
            'update_site_status_id'       => ['nullable', 'uuid', 'exists:project_notification_update_site_statuses,id'],
    ...
    public function toDTO(): CreateProjectNotificationDTO
    {
        ...
        return new CreateProjectNotificationDTO(
            ...
            type: $this->input('type', 'electricity'),
            ...
            contractorTechnicianId: $this->input('contractor_technician_id'),
            contractorTechnicianNumber: $this->input('contractor_technician_number'),
            ...
            poleNumber: $this->input('pole_number'),
            ...
            updateSiteStatusId: $this->input('update_site_status_id'),
