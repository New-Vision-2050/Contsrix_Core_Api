...
class AttendanceTeamPresenterAbsentTest extends TestCase
{
    public function test_absent_row_is_presented_as_absent(): void
    {
        ...
        $payload = (new AttendanceTeamPresenter($attendance))->present();
