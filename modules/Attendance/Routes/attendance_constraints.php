...
Route::middleware(['auth:api', 'tenant'])->prefix('attendance/constraints')->group(function () {
    ...
    Route::post('/validate', [AttendanceConstraintController::class, 'validateConstraints'])
