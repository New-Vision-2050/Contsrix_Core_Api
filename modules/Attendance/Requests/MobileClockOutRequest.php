...
class MobileClockOutRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'attendance_id.required' => 'An attendance record ID is required to clock out.',
            'attendance_id.exists' => 'The specified attendance record does not exist.',
