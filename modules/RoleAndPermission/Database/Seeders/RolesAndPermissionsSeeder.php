...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    private function getDefaultPermissions(): array
    {
        return [
            ...
            'setting.permission.assign',

            "setting.identifier.list",
            "setting.login-way.create",
            "setting.login-way.update",
            "setting.login-way.view",
            "setting.login-way.delete",
            "setting.login-way.activate",

            "setting.driver.view",
            "setting.driver.update",
