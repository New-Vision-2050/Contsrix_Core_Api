...
class UpdateCompanyOfficialDocumentHandler
{
    ...
    public function handle(UpdateCompanyOfficialDocumentCommand $companyOfficialDocumentCommand)
    {
        ...
        return $this->repository->updateCompanyOfficialDocument($companyOfficialDocumentCommand->getId(), $companyOfficialDocumentCommand->toArray(), $companyOfficialDocumentCommand->getFiles());
