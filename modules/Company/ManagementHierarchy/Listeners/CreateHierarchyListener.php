...
////        throw new \Exception(json_encode($company->name));
        ...
        $this->managementHierarchyRepository->createManagementHierarchy(["company_id"=>$event->data->id , "name"=>$event->data->name,"type"=>"branch"],["company_id"=>$event->data->id , "country_id"=>$event->data->country_id]);
