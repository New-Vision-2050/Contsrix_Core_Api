    ...
    public function cloneDepartmentToBranch(CloneDepartmentDTO $dto): ManagementHierarchy
    {
        try {
            ...
            if ($dto->targetParentId) {
                ...
                // If only branch ID is provided, use the main management under the target branch
                $targetBranch = $this->repository->findOneByOrFail([
                    'id' => $branchId,
                    'type' => 'branch'
                ]);
