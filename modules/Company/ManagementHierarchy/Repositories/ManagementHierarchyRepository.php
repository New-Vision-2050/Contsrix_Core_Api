...
class ManagementHierarchyRepository extends BaseRepository
{
    ...
    public function createBranch(array $branchData, array $addressData): ManagementHierarchy
    {
        try {
            ...
            $this->createManagement(["company_id" => $managementHierarchy->company_id,"parent_id"=>$managementHierarchy->id, "is_main"=>1,"name" => " الادارة العامة لفرع $managementHierarchy->name ", "type" => "management"], ["description"=>"الادارة العامة","branch_id"=>$managementHierarchy->id],[]);
