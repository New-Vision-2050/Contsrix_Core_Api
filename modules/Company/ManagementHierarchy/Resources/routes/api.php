...
Route::group(['middleware' => ['auth:api', \Stancl\Tenancy\Middleware\InitializeTenancyByRequestData::class]], function () {
    ...
    Route::post('/create-branch', [ManagementHierarchyController::class, 'createBranch'])->permission(Permission::ORGANIZATION_BRANCH_CREATE());
    Route::post('/create-management', [ManagementHierarchyController::class, 'createManagement'])->permission(Permission::ORGANIZATION_MANAGEMENT_CREATE());
