...
class UniqueTranslationRule implements Rule
{
    ...
    {
        $localeLabel = $this->locale === 'ar' ? __('validation.arabic') : __('validation.english');
        $attributeName = __('validation.attributes.' . $this->column);
        
        return __('validation.unique_translation', [
            'locale' => $localeLabel,
