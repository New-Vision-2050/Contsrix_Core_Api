...
return [
    ...
    'workflow-action-required-detailed' => 'لديك رسالة جديدة في البريد الوارد: :step (الخطوة رقم :order). يرجى مراجعة التطبيق.',
    'workflow-push-action-required-title' => 'إجراء مطلوب',
    'workflow-push-action-required-body' => 'لديك رسالة جديدة في البريد الوارد: :step (الخطوة رقم :order). يرجى مراجعة التطبيق.',
