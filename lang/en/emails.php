...
return [
    ...
    'workflow-action-required-detailed' => 'You have a new inbox message: :step (step number :order). Please review the app.',
    'workflow-push-action-required-title' => 'Action Required',
    'workflow-push-action-required-body' => 'You have a new inbox message: :step (step number :order). Please review the app.',
